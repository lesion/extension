...
},{"./extractor":2,"./hattori":3,"underscore":9}],2:[function(require,module,exports){
'use strict';
/*jshint -W061 */
...
var cayley = 'http://ec2-54-191-175-209.us-west-2.compute.amazonaws.com:64210/api/v1/query/gremlin';
...
function enrich(pair, callback) {
    ...
    if(matches) {
        var url = 'http://ec2-54-191-175-209.us-west-2.compute.amazonaws.com:4567/software_metadata?url=github.com/' + matches[1] + '/' + matches[2];
        if(cache[url]) {
